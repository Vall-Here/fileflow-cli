 ...
 */
function getDestinationFolder(filePath, strategy) {
 ...
 */
async function organizeFiles(targetDir, options) {
...
export function registerOrganizeCommand(program) {
  program
    ...
    .example('fileflow organize ./downloads')
    .example('fileflow organize ./downloads --by date')
    .example('fileflow organize ./downloads --by size --dry-run')
